...
addon_id        = 'plugin.video.viptv'
addon           = Addon(addon_id, sys.argv)
icon            = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id, 'icon.png'))

def Index():
        GetLinks('https://pastebin.com/raw.php?i=rHKQpwmE')
...
def TWITTER():
        text = ''
        twit = 'https://script.google.com/macros/s/AKfycbyA1pDMk916Z4aRqouWLSb-xPf3xw8FXS3XNWg6-nbIDa0iIQI/exec'
        link = open_url(twit)
        link = link.replace('/n','')
        ...
        for status, dte in match:
            ...
            text = text+dte+'\n'+status+'\n'+'\n'
        showText('[COLOR blue][B]@gh0st4k0[/B][/COLOR]', text)
